#' @templateVar MODEL_FUNCTION bart_prospect_lossaversion
...
#' @templateVar MODEL_NAME Simple model with multiplicative loss aversion
#' @templateVar MODEL_CODE prospect_lossaversion
#' @templateVar MODEL_CITE 
#' @templateVar MODEL_TYPE Hierarchical
#' @templateVar DATA_COLUMNS "subjID", "pumps", "explosion"
#' @templateVar PARAMETERS \code{loss_aversion} (multiplied by loss value)
...
bart_prospect_lossaversion <- hBayesDM_model(
  task_name       = "bart",

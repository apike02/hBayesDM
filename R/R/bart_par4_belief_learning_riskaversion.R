#' @templateVar MODEL_FUNCTION bart_par4_belief_learning_riskaversion
...
#' @templateVar MODEL_NAME Re-parameterized version of BART model with 3 params - belief, learning and risk aversion
#' @templateVar MODEL_CODE par4_belief_learning_riskaversion
#' @templateVar MODEL_CITE (van Ravenzwaaij et al., 2011)
#' @templateVar MODEL_TYPE Hierarchical
#' @templateVar DATA_COLUMNS "subjID", "pumps", "explosion"
#' @templateVar PARAMETERS \code{phi} (prior belief of balloon not bursting), \code{eta} (updating rate), \code{gam} (risk-taking parameter)
...
bart_par4_belief_learning_riskaversion <- hBayesDM_model(
  task_name       = "bart",

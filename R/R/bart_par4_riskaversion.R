#' @templateVar MODEL_FUNCTION bart_par4_riskaversion
...
#' @templateVar MODEL_NAME Re-parameterized version of BART model with only a risk aversion parameter
#' @templateVar MODEL_CODE par4_riskaversion
#' @templateVar MODEL_CITE (van Ravenzwaaij et al., 2011)
#' @templateVar MODEL_TYPE Hierarchical
#' @templateVar DATA_COLUMNS "subjID", "pumps", "explosion"
#' @templateVar PARAMETERS \code{gam} (risk-taking parameter)
...
bart_par4_riskaversion <- hBayesDM_model(
  task_name       = "bart",

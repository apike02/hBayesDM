#' @templateVar MODEL_FUNCTION bart_prospect_belief_riskaversion_lossaversion
...
#' @templateVar MODEL_NAME Simple model with a prior belief, risk aversion and multiplicative loss aversion
#' @templateVar MODEL_CODE prospect_belief_riskaversion_lossaversion
#' @templateVar MODEL_CITE 
#' @templateVar MODEL_TYPE Hierarchical
#' @templateVar DATA_COLUMNS "subjID", "pumps", "explosion"
#' @templateVar PARAMETERS \code{pumps_prior_belief} (prior belief of burst), \code{risk_aversion} (subtracted from overall expected value), \code{loss_aversion} (multiplied by loss value)
...
bart_prospect_belief_riskaversion_lossaversion <- hBayesDM_model(
  task_name       = "bart",

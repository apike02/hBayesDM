#' @templateVar MODEL_FUNCTION bart_withintrial_2par
...
#' @templateVar MODEL_NAME BART model where the number of pumps is updated within trials, no prior belief and no learning
#' @templateVar MODEL_CODE withintrial_2par
#' @templateVar MODEL_CITE 
#' @templateVar MODEL_TYPE Hierarchical
#' @templateVar DATA_COLUMNS "subjID", "pumps", "explosion"
#' @templateVar PARAMETERS \code{risk_taking} (risk taking parameter - scales tendency to press more within-trial), \code{noise} (inverse temperature)
...
bart_withintrial_2par <- hBayesDM_model(
  task_name       = "bart",

#' @templateVar MODEL_FUNCTION bart_prospect_belief
...
#' @templateVar MODEL_CODE prospect_belief
#' @templateVar MODEL_CITE 
#' @templateVar MODEL_TYPE Hierarchical
#' @templateVar DATA_COLUMNS "subjID", "pumps", "explosion"
#' @templateVar PARAMETERS \code{pumps_prior_belief} (prior belief of burst)
...
bart_prospect_belief <- hBayesDM_model(
  task_name       = "bart",

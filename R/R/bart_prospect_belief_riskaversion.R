#' @templateVar MODEL_FUNCTION bart_prospect_belief_riskaversion
...
#' @templateVar MODEL_NAME Simple model with a prior belief and summative risk aversion
#' @templateVar MODEL_CODE prospect_belief_riskaversion
#' @templateVar MODEL_CITE 
#' @templateVar MODEL_TYPE Hierarchical
#' @templateVar DATA_COLUMNS "subjID", "pumps", "explosion"
#' @templateVar PARAMETERS \code{pumps_prior_belief} (prior belief of burst), \code{risk_aversion} (additive value that makes you less likely to pump)
...
bart_prospect_belief_riskaversion <- hBayesDM_model(
  task_name       = "bart",

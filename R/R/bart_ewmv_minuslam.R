#' @templateVar MODEL_FUNCTION bart_ewmv_minuslam
...
#' @templateVar MODEL_NAME Exponential-Weight Mean-Variance Model without Lambda
#' @templateVar MODEL_CODE ewmv_minuslam
#' @templateVar MODEL_CITE (Park et al., 2020)
#' @templateVar MODEL_TYPE Hierarchical
#' @templateVar DATA_COLUMNS "subjID", "pumps", "explosion"
#' @templateVar PARAMETERS \code{phi} (prior belief of burst), \code{eta} (updating exponent), \code{rho} (risk preference), \code{tau} (inverse temperature)
...
bart_ewmv_minuslam <- hBayesDM_model(
  task_name       = "bart",

#' @templateVar MODEL_FUNCTION bart_prospect_belief_noise
...
#' @templateVar MODEL_NAME Simple model with a prior belief and decision noise
#' @templateVar MODEL_CODE prospect_belief_noise
#' @templateVar MODEL_CITE 
#' @templateVar MODEL_TYPE Hierarchical
#' @templateVar DATA_COLUMNS "subjID", "pumps", "explosion"
#' @templateVar PARAMETERS \code{pumps_prior_belief} (prior belief of burst), \code{inverse_temperature} (governs decision noise, ranging from 0 (stochastic) to infinite (deterministic))
...
bart_prospect_belief_noise <- hBayesDM_model(
  task_name       = "bart",

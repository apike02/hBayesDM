#' @templateVar MODEL_FUNCTION bart_par4_withintrial
...
#' @templateVar MODEL_NAME Re-parameterized version of BART model with learning updates within trial
#' @templateVar MODEL_CODE par4_withintrial
...
bart_par4_withintrial <- hBayesDM_model(
  task_name       = "bart",

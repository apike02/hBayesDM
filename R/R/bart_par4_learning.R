#' @templateVar MODEL_FUNCTION bart_par4_learning
...
#' @templateVar MODEL_NAME Re-parameterized version of BART model with only a learning rate (and a fixed effect of prior belief)
#' @templateVar MODEL_CODE par4_learning
#' @templateVar MODEL_CITE (van Ravenzwaaij et al., 2011)
#' @templateVar MODEL_TYPE Hierarchical
#' @templateVar DATA_COLUMNS "subjID", "pumps", "explosion"
#' @templateVar PARAMETERS \code{eta} (updating rate)
...
bart_par4_learning <- hBayesDM_model(
  task_name       = "bart",

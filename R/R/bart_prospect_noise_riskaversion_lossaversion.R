#' @templateVar MODEL_FUNCTION bart_prospect_noise_riskaversion_lossaversion
...
#' @templateVar MODEL_NAME Simple model with decision noise and risk aversion and multiplicative loss aversion
#' @templateVar MODEL_CODE prospect_noise_riskaversion_lossaversion
#' @templateVar MODEL_CITE 
#' @templateVar MODEL_TYPE Hierarchical
#' @templateVar DATA_COLUMNS "subjID", "pumps", "explosion"
#' @templateVar PARAMETERS \code{inverse_temperature} (governs decision noise, ranging from 0 (stochastic) to infinite (deterministic)), \code{risk_aversion} (subtracted from overall expected value), \code{loss_aversion} (multiplied by loss value)
...
bart_prospect_noise_riskaversion_lossaversion <- hBayesDM_model(
  task_name       = "bart",

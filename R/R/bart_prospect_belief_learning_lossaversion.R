#' @templateVar MODEL_FUNCTION bart_prospect_belief_learning_lossaversion
...
#' @templateVar MODEL_NAME Simple model with prior belief that is updated IF there is an explosion or the pumps are greater than the prior and multiplicative loss aversion
#' @templateVar MODEL_CODE prospect_belief_learning_lossaversion
#' @templateVar MODEL_CITE 
#' @templateVar MODEL_TYPE Hierarchical
#' @templateVar DATA_COLUMNS "subjID", "pumps", "explosion"
#' @templateVar PARAMETERS \code{pumps_prior_belief} (prior belief of burst), \code{learning_rate} (rate at which belief of burst is updated), \code{loss_aversion} (multiplied by loss value)
...
bart_prospect_belief_learning_lossaversion <- hBayesDM_model(
  task_name       = "bart",

#' @templateVar MODEL_FUNCTION bart_par4_noise_riskaversion
...
#' @templateVar MODEL_NAME Re-parameterized version of BART model with 2 params - inverse temperature and risk-aversion (and fixed effect of prior belief)
#' @templateVar MODEL_CODE par4_noise_riskaversion
#' @templateVar MODEL_CITE (van Ravenzwaaij et al., 2011)
#' @templateVar MODEL_TYPE Hierarchical
#' @templateVar DATA_COLUMNS "subjID", "pumps", "explosion"
#' @templateVar PARAMETERS \code{gam} (risk-taking parameter), \code{tau} (inverse temperature)
...
bart_par4_noise_riskaversion <- hBayesDM_model(
  task_name       = "bart",

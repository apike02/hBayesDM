#' @templateVar MODEL_FUNCTION bart_par4_belief
...
#' @templateVar MODEL_NAME Re-parameterized version of BART model with a single param (prior belief)
#' @templateVar MODEL_CODE par4_belief
#' @templateVar MODEL_CITE (van Ravenzwaaij et al., 2011)
#' @templateVar MODEL_TYPE Hierarchical
#' @templateVar DATA_COLUMNS "subjID", "pumps", "explosion"
#' @templateVar PARAMETERS \code{phi} (prior belief of balloon not bursting)
...
bart_par4_belief <- hBayesDM_model(
  task_name       = "bart",

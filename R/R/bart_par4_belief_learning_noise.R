#' @templateVar MODEL_FUNCTION bart_par4_belief_learning_noise
...
#' @templateVar MODEL_NAME Re-parameterized version of BART model with 3 params - prior belief, learning rate and noise
#' @templateVar MODEL_CODE par4_belief_learning_noise
#' @templateVar MODEL_CITE (van Ravenzwaaij et al., 2011)
#' @templateVar MODEL_TYPE Hierarchical
#' @templateVar DATA_COLUMNS "subjID", "pumps", "explosion"
#' @templateVar PARAMETERS \code{phi} (prior belief of balloon not bursting), \code{eta} (updating rate), \code{tau} (inverse temperature)
...
bart_par4_belief_learning_noise <- hBayesDM_model(
  task_name       = "bart",

#' @templateVar MODEL_FUNCTION bart_prospect_belief_learning_riskaversion
...
#' @templateVar MODEL_NAME Simple model with a prior belief that is updated IF there is an explosion or the pumps are greater than the prior and summative risk aversion
#' @templateVar MODEL_CODE prospect_belief_learning_riskaversion
#' @templateVar MODEL_CITE 
#' @templateVar MODEL_TYPE Hierarchical
#' @templateVar DATA_COLUMNS "subjID", "pumps", "explosion"
#' @templateVar PARAMETERS \code{pumps_prior_belief} (prior belief of burst), \code{learning_rate} (rate at which belief of burst is updated), \code{risk_aversion} (additive value that makes you less likely to pump)
...
bart_prospect_belief_learning_riskaversion <- hBayesDM_model(
  task_name       = "bart",

#' @templateVar MODEL_FUNCTION bart_prospect_belief_lossaversion
...
#' @templateVar MODEL_NAME Simple model with a prior belief and loss aversion multiplied by loss value
#' @templateVar MODEL_CODE prospect_belief_lossaversion
#' @templateVar MODEL_CITE 
#' @templateVar MODEL_TYPE Hierarchical
#' @templateVar DATA_COLUMNS "subjID", "pumps", "explosion"
#' @templateVar PARAMETERS \code{pumps_prior_belief} (prior belief of burst), \code{loss_aversion} (multiplied with loss outcome)
...
bart_prospect_belief_lossaversion <- hBayesDM_model(
  task_name       = "bart",

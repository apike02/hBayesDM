#' @templateVar MODEL_FUNCTION bart_ewmv_minusrho
...
#' @templateVar MODEL_NAME Exponential-Weight Mean-Variance Model without Rho
#' @templateVar MODEL_CODE ewmv_minusrho
#' @templateVar MODEL_CITE (Park et al., 2020)
#' @templateVar MODEL_TYPE Hierarchical
#' @templateVar DATA_COLUMNS "subjID", "pumps", "explosion"
#' @templateVar PARAMETERS \code{phi} (prior belief of burst), \code{eta} (updating exponent), \code{tau} (inverse temperature), \code{lambda} (loss aversion)
...
bart_ewmv_minusrho <- hBayesDM_model(
  task_name       = "bart",

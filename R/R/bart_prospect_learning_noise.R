#' @templateVar MODEL_FUNCTION bart_prospect_learning_noise
...
#' @templateVar MODEL_NAME Simple model with learning rate and decision noise
#' @templateVar MODEL_CODE prospect_learning_noise
#' @templateVar MODEL_CITE 
#' @templateVar MODEL_TYPE Hierarchical
#' @templateVar DATA_COLUMNS "subjID", "pumps", "explosion"
#' @templateVar PARAMETERS \code{learning_rate} (rate at which belief of burst is updated), \code{inverse_temperature} (governs decision noise, ranging from 0 (stochastic) to infinite (deterministic))
...
bart_prospect_learning_noise <- hBayesDM_model(
  task_name       = "bart",

#' @templateVar MODEL_FUNCTION bart_prospect_noise
...
#' @templateVar MODEL_NAME Simple model with only decision noise
#' @templateVar MODEL_CODE prospect_noise
#' @templateVar MODEL_CITE 
#' @templateVar MODEL_TYPE Hierarchical
#' @templateVar DATA_COLUMNS "subjID", "pumps", "explosion"
#' @templateVar PARAMETERS \code{inverse_temperature} (governs decision noise, ranging from 0 (stochastic) to infinite (deterministic))
...
bart_prospect_noise <- hBayesDM_model(
  task_name       = "bart",

#' @templateVar MODEL_FUNCTION bart_par4_learning_riskaversion
...
#' @templateVar MODEL_NAME Re-parameterized version of BART model with 2 params - learning rate and risk aversion (fixed effect of prior belief)
#' @templateVar MODEL_CODE par4_learning_riskaversion
#' @templateVar MODEL_CITE (van Ravenzwaaij et al., 2011)
#' @templateVar MODEL_TYPE Hierarchical
#' @templateVar DATA_COLUMNS "subjID", "pumps", "explosion"
#' @templateVar PARAMETERS \code{eta} (updating rate), \code{gam} (risk-taking parameter)
...
bart_par4_learning_riskaversion <- hBayesDM_model(
  task_name       = "bart",

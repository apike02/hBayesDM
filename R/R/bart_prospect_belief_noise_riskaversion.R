#' @templateVar MODEL_FUNCTION bart_prospect_belief_noise_riskaversion
...
#' @templateVar MODEL_NAME Simple model with a prior belief and decision noise and risk aversion
#' @templateVar MODEL_CODE prospect_belief_noise_riskaversion
#' @templateVar MODEL_CITE 
#' @templateVar MODEL_TYPE Hierarchical
#' @templateVar DATA_COLUMNS "subjID", "pumps", "explosion"
#' @templateVar PARAMETERS \code{pumps_prior_belief} (prior belief of burst), \code{inverse_temperature} (governs decision noise, ranging from 0 (stochastic) to infinite (deterministic)), \code{risk_aversion} (subtracted from overall expected value)
...
bart_prospect_belief_noise_riskaversion <- hBayesDM_model(
  task_name       = "bart",

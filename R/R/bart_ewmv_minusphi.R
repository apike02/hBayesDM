#' @templateVar MODEL_FUNCTION bart_ewmv_minusphi
...
#' @templateVar MODEL_NAME Exponential-Weight Mean-Variance Model without phi
#' @templateVar MODEL_CODE ewmv_minusphi
#' @templateVar MODEL_CITE (Park et al., 2020)
#' @templateVar MODEL_TYPE Hierarchical
#' @templateVar DATA_COLUMNS "subjID", "pumps", "explosion"
#' @templateVar PARAMETERS \code{eta} (updating exponent), \code{rho} (risk preference), \code{tau} (inverse temperature), \code{lambda} (loss aversion)
...
bart_ewmv_minusphi <- hBayesDM_model(
  task_name       = "bart",

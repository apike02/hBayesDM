#' @templateVar MODEL_FUNCTION bart_ewmv_minustau
...
#' @templateVar MODEL_NAME Exponential-Weight Mean-Variance Model without Tau
#' @templateVar MODEL_CODE ewmv_minustau
#' @templateVar MODEL_CITE (Park et al., 2020)
#' @templateVar MODEL_TYPE Hierarchical
#' @templateVar DATA_COLUMNS "subjID", "pumps", "explosion"
#' @templateVar PARAMETERS \code{phi} (prior belief of burst), \code{eta} (updating exponent), \code{rho} (risk preference), \code{lambda} (loss aversion)
...
bart_ewmv_minustau <- hBayesDM_model(
  task_name       = "bart",

...
__all__ = ['bart_ewmv_minusrho']


class BartEwmvMinusrho(TaskModel):
    def __init__(self, **kwargs):
        super().__init__(
            task_name='bart',
            model_name='ewmv_minusrho',
            model_type='',
            data_columns=(
                'subjID',
                'pumps',
...
def bart_ewmv_minusrho(
    ...
    """Balloon Analogue Risk Task - Exponential-Weight Mean-Variance Model without Rho

    Hierarchical Bayesian Modeling of the Balloon Analogue Risk Task 
    using Exponential-Weight Mean-Variance Model without Rho [Park2020]_ with the following parameters:
    "phi" (prior belief of burst), "eta" (updating exponent), "tau" (inverse temperature), "lambda" (loss aversion).
    ...
    **additional_args
    ...
    model_data
        ...
        - ``model``: String value that is the name of the model ('bart_ewmv_minusrho').
    ...
    .. code:: python
        ...
        output = bart_ewmv_minusrho(data='example', niter=2000, nwarmup=1000, nchain=4, ncore=4)

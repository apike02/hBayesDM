...
__all__ = ['bart_ewmv_minuseta']


class BartEwmvMinuseta(TaskModel):
...
def bart_ewmv_minuseta(
    ...
    """Balloon Analogue Risk Task - Exponential-Weight Mean-Variance Model without Eta

    Hierarchical Bayesian Modeling of the Balloon Analogue Risk Task 
    using Exponential-Weight Mean-Variance Model without Eta [Park2020]_ with the following parameters:
    "phi" (prior belief of burst), "rho" (risk preference), "tau" (inverse temperature), "lambda" (loss aversion).
    ...
    **additional_args
    ...
    model_data
        ...
        - ``model``: String value that is the name of the model ('bart_ewmv_minuseta').
    ...
    .. code:: python
        ...
        output = bart_ewmv_minuseta(data='example', niter=2000, nwarmup=1000, nchain=4, ncore=4)

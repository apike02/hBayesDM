...
__all__ = ['bart_par4_belief_riskaversion']


class BartPar4BeliefRiskaversion(TaskModel):
    def __init__(self, **kwargs):
        super().__init__(
            task_name='bart',
            model_name='par4_belief_riskaversion',
            model_type='',
            data_columns=(
                'subjID',
                'pumps',
...
def bart_par4_belief_riskaversion(
    ...
    """Balloon Analogue Risk Task - Re-parameterized version of BART model with 2 params - prior belief and risk aversion

    Hierarchical Bayesian Modeling of the Balloon Analogue Risk Task 
    using Re-parameterized version of BART model with 2 params - prior belief and risk aversion [van_Ravenzwaaij2011]_ with the following parameters:
    "phi" (prior belief of balloon not bursting), "gam" (risk-taking parameter).
    ...
    **additional_args
    ...
    model_data
        ...
        - ``model``: String value that is the name of the model ('bart_par4_belief_riskaversion').
    ...
    .. code:: python
        ...
        output = bart_par4_belief_riskaversion(data='example', niter=2000, nwarmup=1000, nchain=4, ncore=4)
        ...
        print_fit(output)
    """
    return BartPar4BeliefRiskaversion(
        data=data,
        niter=niter,
        nwarmup=nwarmup,
        nchain=nchain,

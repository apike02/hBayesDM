    ...
    def __init__(self, **kwargs):
        super().__init__(
            ...
            parameters_desc=OrderedDict([
                ...
                ('punsens', 'punishment sensitivity'),
...
def bart_stl(
    ...
    """Balloon Analogue Risk Task - BART model from https://doi.org/10.1016/j.cogpsych.2021.101407

    Hierarchical Bayesian Modeling of the Balloon Analogue Risk Task 
    using BART model from https://doi.org/10.1016/j.cogpsych.2021.101407 [Zhou2021]_ with the following parameters:
    "target_pumps" (prior expectation for how many pumps result in explosion), "rewsens" (reward sensitivity), "punsens" (punishment sensitivity), "noise" (inverse temperature).

    

    
    .. [Zhou2021] Zhou, R., Myung, J. I., & Pitt, M.A. (2021). The scaled target learning model: Revisiting learning in the balloon analogue risk task. Cognitive Psychology, 128, 101407.
    ...
    **additional_args
    ...
    model_data
        ...
        - ``model``: String value that is the name of the model ('bart_stl').
    ...
    .. code:: python
        ...
        output = bart_stl(data='example', niter=2000, nwarmup=1000, nchain=4, ncore=4)

...
__all__ = ['bart_ewmv_minustau']


class BartEwmvMinustau(TaskModel):
    def __init__(self, **kwargs):
        super().__init__(
            task_name='bart',
            model_name='ewmv_minustau',
            model_type='',
            data_columns=(
                'subjID',
                'pumps',
...
def bart_ewmv_minustau(
    ...
    """Balloon Analogue Risk Task - Exponential-Weight Mean-Variance Model without Tau

    Hierarchical Bayesian Modeling of the Balloon Analogue Risk Task 
    using Exponential-Weight Mean-Variance Model without Tau [Park2020]_ with the following parameters:
    "phi" (prior belief of burst), "eta" (updating exponent), "rho" (risk preference), "lambda" (loss aversion).
    ...
    **additional_args
    ...
    model_data
        ...
        - ``model``: String value that is the name of the model ('bart_ewmv_minustau').
    ...
    .. code:: python
        ...
        output = bart_ewmv_minustau(data='example', niter=2000, nwarmup=1000, nchain=4, ncore=4)

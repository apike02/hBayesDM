...
__all__ = ['bart_prospect_belief_learning_lossaversion']


class BartProspectBeliefLearningLossaversion(TaskModel):
    def __init__(self, **kwargs):
        super().__init__(
            task_name='bart',
            model_name='prospect_belief_learning_lossaversion',
            model_type='',
            data_columns=(
                'subjID',
                'pumps',
...
def bart_prospect_belief_learning_lossaversion(
    ...
    """Balloon Analogue Risk Task - Simple model with prior belief that is updated IF there is an explosion or the pumps are greater than the prior and multiplicative loss aversion

    Hierarchical Bayesian Modeling of the Balloon Analogue Risk Task 
    using Simple model with prior belief that is updated IF there is an explosion or the pumps are greater than the prior and multiplicative loss aversion  with the following parameters:
    "pumps_prior_belief" (prior belief of burst), "learning_rate" (rate at which belief of burst is updated), "loss_aversion" (multiplied by loss value).
    ...
    **additional_args
    ...
    model_data
        ...
        - ``model``: String value that is the name of the model ('bart_prospect_belief_learning_lossaversion').
    ...
    .. code:: python
        ...
        output = bart_prospect_belief_learning_lossaversion(data='example', niter=2000, nwarmup=1000, nchain=4, ncore=4)
        ...
        print_fit(output)
    """
    return BartProspectBeliefLearningLossaversion(
        data=data,
        niter=niter,
        nwarmup=nwarmup,
        nchain=nchain,

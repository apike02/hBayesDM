...
__all__ = ['bart_prospect_phi']


class BartProspectPhi(TaskModel):
...
def bart_prospect_phi(
    ...
    """Balloon Analogue Risk Task - Very simple model with only a single prior belief

    Hierarchical Bayesian Modeling of the Balloon Analogue Risk Task 
    using Very simple model with only a single prior belief [Park2020]_ with the following parameters:
    "phi" (prior belief of burst).
    ...
    **additional_args
    ...
    model_data
        ...
        - ``model``: String value that is the name of the model ('bart_prospect_phi').
    ...
    .. code:: python
        ...
        output = bart_prospect_phi(data='example', niter=2000, nwarmup=1000, nchain=4, ncore=4)

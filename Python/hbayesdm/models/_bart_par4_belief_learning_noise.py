...
__all__ = ['bart_par4_belief_learning_noise']


class BartPar4BeliefLearningNoise(TaskModel):
    def __init__(self, **kwargs):
        super().__init__(
            task_name='bart',
            model_name='par4_belief_learning_noise',
            model_type='',
            data_columns=(
                'subjID',
                'pumps',
...
def bart_par4_belief_learning_noise(
    ...
    """Balloon Analogue Risk Task - Re-parameterized version of BART model with 3 params - prior belief, learning rate and noise

    Hierarchical Bayesian Modeling of the Balloon Analogue Risk Task 
    using Re-parameterized version of BART model with 3 params - prior belief, learning rate and noise [van_Ravenzwaaij2011]_ with the following parameters:
    "phi" (prior belief of balloon not bursting), "eta" (updating rate), "tau" (inverse temperature).
    ...
    **additional_args
    ...
    model_data
        ...
        - ``model``: String value that is the name of the model ('bart_par4_belief_learning_noise').
    ...
    .. code:: python
        ...
        from hbayesdm.models import bart_par4_belief_learning_noise

        # Run the model and store results in "output"
        output = bart_par4_belief_learning_noise(data='example', niter=2000, nwarmup=1000, nchain=4, ncore=4)
        ...
        print_fit(output)
    """
    return BartPar4BeliefLearningNoise(
        data=data,
        niter=niter,
        nwarmup=nwarmup,
        nchain=nchain,

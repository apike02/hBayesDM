...
__all__ = ['bart_par4_learning_riskaversion']


class BartPar4LearningRiskaversion(TaskModel):
    def __init__(self, **kwargs):
        super().__init__(
            task_name='bart',
            model_name='par4_learning_riskaversion',
            model_type='',
            data_columns=(
                'subjID',
                'pumps',
...
def bart_par4_learning_riskaversion(
    ...
    """Balloon Analogue Risk Task - Re-parameterized version of BART model with 2 params - learning rate and risk aversion (fixed effect of prior belief)

    Hierarchical Bayesian Modeling of the Balloon Analogue Risk Task 
    using Re-parameterized version of BART model with 2 params - learning rate and risk aversion (fixed effect of prior belief) [van_Ravenzwaaij2011]_ with the following parameters:
    "eta" (updating rate), "gam" (risk-taking parameter).
    ...
    **additional_args
    ...
    model_data
        ...
        - ``model``: String value that is the name of the model ('bart_par4_learning_riskaversion').
    ...
    .. code:: python
        ...
        output = bart_par4_learning_riskaversion(data='example', niter=2000, nwarmup=1000, nchain=4, ncore=4)
        ...
        print_fit(output)
    """
    return BartPar4LearningRiskaversion(
        data=data,
        niter=niter,
        nwarmup=nwarmup,
        nchain=nchain,

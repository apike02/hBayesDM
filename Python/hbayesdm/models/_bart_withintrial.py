...
__all__ = ['bart_withintrial']


class BartWithintrial(TaskModel):
    def __init__(self, **kwargs):
        super().__init__(
            ...
            parameters=OrderedDict([
                ('target_pumps', (0, 1, Inf)),
                ('learningrate', (0, 0.5, 1)),
                ('risk_taking', (0, 0.5, 1)),
                ('noise', (0, 1, Inf)),
            ]),
            ...
            parameters_desc=OrderedDict([
                ('target_pumps', 'prior expectation for how many pumps result in explosion'),
                ('learningrate', 'learning rate - scales learning post-trial'),
                ('risk_taking', 'risk taking parameter - scales tendency to press more within-trial'),
                ('noise', 'inverse temperature'),
            ]),
...
def bart_withintrial(
    ...
    """Balloon Analogue Risk Task - BART model where the number of pumps is updated within trials

    Hierarchical Bayesian Modeling of the Balloon Analogue Risk Task 
    using BART model where the number of pumps is updated within trials  with the following parameters:
    "target_pumps" (prior expectation for how many pumps result in explosion), "learningrate" (learning rate - scales learning post-trial), "risk_taking" (risk taking parameter - scales tendency to press more within-trial), "noise" (inverse temperature).
    ...
    .. codeauthor:: Ayoung Lee <aylee2008@naver.com>
    ...
    **additional_args
    ...
    model_data
        ...
        - ``model``: String value that is the name of the model ('bart_withintrial').
    ...
    .. code:: python
        ...
        output = bart_withintrial(data='example', niter=2000, nwarmup=1000, nchain=4, ncore=4)

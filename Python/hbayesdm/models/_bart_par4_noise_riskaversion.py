...
__all__ = ['bart_par4_noise_riskaversion']


class BartPar4NoiseRiskaversion(TaskModel):
    def __init__(self, **kwargs):
        super().__init__(
            task_name='bart',
            model_name='par4_noise_riskaversion',
            model_type='',
            data_columns=(
                'subjID',
                'pumps',
...
def bart_par4_noise_riskaversion(
    ...
    """Balloon Analogue Risk Task - Re-parameterized version of BART model with 2 params - inverse temperature and risk-aversion (and fixed effect of prior belief)

    Hierarchical Bayesian Modeling of the Balloon Analogue Risk Task 
    using Re-parameterized version of BART model with 2 params - inverse temperature and risk-aversion (and fixed effect of prior belief) [van_Ravenzwaaij2011]_ with the following parameters:
    "gam" (risk-taking parameter), "tau" (inverse temperature).
    ...
    **additional_args
    ...
    model_data
        ...
        - ``model``: String value that is the name of the model ('bart_par4_noise_riskaversion').
    ...
    .. code:: python
        ...
        output = bart_par4_noise_riskaversion(data='example', niter=2000, nwarmup=1000, nchain=4, ncore=4)
        ...
        print_fit(output)
    """
    return BartPar4NoiseRiskaversion(
        data=data,
        niter=niter,
        nwarmup=nwarmup,
        nchain=nchain,

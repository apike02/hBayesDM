...
__all__ = ['bart_par4_learning']


class BartPar4Learning(TaskModel):
    def __init__(self, **kwargs):
        super().__init__(
            task_name='bart',
            model_name='par4_learning',
            model_type='',
            data_columns=(
                'subjID',
                'pumps',
...
def bart_par4_learning(
    ...
    """Balloon Analogue Risk Task - Re-parameterized version of BART model with only a learning rate (and a fixed effect of prior belief)

    Hierarchical Bayesian Modeling of the Balloon Analogue Risk Task 
    using Re-parameterized version of BART model with only a learning rate (and a fixed effect of prior belief) [van_Ravenzwaaij2011]_ with the following parameters:
    "eta" (updating rate).
    ...
    **additional_args
    ...
    model_data
        ...
        - ``model``: String value that is the name of the model ('bart_par4_learning').
    ...
    .. code:: python
        ...
        output = bart_par4_learning(data='example', niter=2000, nwarmup=1000, nchain=4, ncore=4)

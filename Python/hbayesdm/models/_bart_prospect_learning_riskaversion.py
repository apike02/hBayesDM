...
def bart_prospect_learning_riskaversion(
    ...
    """Balloon Analogue Risk Task - Simple model with a fixed prior belief that is updated IF there is an explosion or the pumps are greater than the prior and summative risk aversion

    Hierarchical Bayesian Modeling of the Balloon Analogue Risk Task 
    using Simple model with a fixed prior belief that is updated IF there is an explosion or the pumps are greater than the prior and summative risk aversion  with the following parameters:

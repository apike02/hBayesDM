...
__all__ = ['bart_prospect_noise_riskaversion']


class BartProspectNoiseRiskaversion(TaskModel):
    def __init__(self, **kwargs):
        super().__init__(
            task_name='bart',
            model_name='prospect_noise_riskaversion',
            model_type='',
            data_columns=(
                'subjID',
                'pumps',
...
def bart_prospect_noise_riskaversion(
    ...
    "inverse_temperature" (governs decision noise, ranging from 0 (stochastic) to infinite (deterministic)), "risk_aversion" (subtracted from overall expected value).
    ...
    **additional_args
    ...
    model_data
        ...
        - ``model``: String value that is the name of the model ('bart_prospect_noise_riskaversion').
    ...
    .. code:: python
        ...
        output = bart_prospect_noise_riskaversion(data='example', niter=2000, nwarmup=1000, nchain=4, ncore=4)
        ...
        print_fit(output)
    """
    return BartProspectNoiseRiskaversion(
        data=data,
        niter=niter,
        nwarmup=nwarmup,
        nchain=nchain,

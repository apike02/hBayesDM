...
__all__ = ['bart_prospect_noise']


class BartProspectNoise(TaskModel):
    def __init__(self, **kwargs):
        super().__init__(
            task_name='bart',
            model_name='prospect_noise',
            model_type='',
            data_columns=(
                'subjID',
                'pumps',
...
def bart_prospect_noise(
    ...
    """Balloon Analogue Risk Task - Simple model with only decision noise

    Hierarchical Bayesian Modeling of the Balloon Analogue Risk Task 
    using Simple model with only decision noise  with the following parameters:
    "inverse_temperature" (governs decision noise, ranging from 0 (stochastic) to infinite (deterministic)).
    ...
    **additional_args
    ...
    model_data
        ...
        - ``model``: String value that is the name of the model ('bart_prospect_noise').
    ...
    .. code:: python
        ...
        output = bart_prospect_noise(data='example', niter=2000, nwarmup=1000, nchain=4, ncore=4)

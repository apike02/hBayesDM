...
__all__ = ['bart_ewmv_minuslam']


class BartEwmvMinuslam(TaskModel):
    def __init__(self, **kwargs):
        super().__init__(
            task_name='bart',
            model_name='ewmv_minuslam',
            model_type='',
            data_columns=(
                'subjID',
                'pumps',
...
def bart_ewmv_minuslam(
    ...
    """Balloon Analogue Risk Task - Exponential-Weight Mean-Variance Model without Lambda

    Hierarchical Bayesian Modeling of the Balloon Analogue Risk Task 
    using Exponential-Weight Mean-Variance Model without Lambda [Park2020]_ with the following parameters:
    "phi" (prior belief of burst), "eta" (updating exponent), "rho" (risk preference), "tau" (inverse temperature).

    

    
    .. [Park2020] Park, H., Yang, J., Vassileva, J., & Ahn, W. (2020). The Exponential-Weight Mean-Variance Model: A novel computational model for the Balloon Analogue Risk Task. https://doi.org/10.31234/osf.io/sdzj4
    ...
    **additional_args
    ...
    model_data
        ...
        - ``model``: String value that is the name of the model ('bart_ewmv_minuslam').
    ...
    .. code:: python
        ...
        output = bart_ewmv_minuslam(data='example', niter=2000, nwarmup=1000, nchain=4, ncore=4)

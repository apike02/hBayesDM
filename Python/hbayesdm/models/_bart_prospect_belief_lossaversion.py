...
__all__ = ['bart_prospect_belief_lossaversion']


class BartProspectBeliefLossaversion(TaskModel):
    def __init__(self, **kwargs):
        super().__init__(
            task_name='bart',
            model_name='prospect_belief_lossaversion',
            model_type='',
            data_columns=(
                'subjID',
                'pumps',
            ...
            parameters_desc=OrderedDict([
                ...
                ('loss_aversion', 'multiplied with loss outcome'),
            ]),
...
def bart_prospect_belief_lossaversion(
    ...
    """Balloon Analogue Risk Task - Simple model with a prior belief and loss aversion multiplied by loss value

    Hierarchical Bayesian Modeling of the Balloon Analogue Risk Task 
    using Simple model with a prior belief and loss aversion multiplied by loss value  with the following parameters:
    "pumps_prior_belief" (prior belief of burst), "loss_aversion" (multiplied with loss outcome).
    ...
    **additional_args
    ...
    model_data
        ...
        - ``model``: String value that is the name of the model ('bart_prospect_belief_lossaversion').
    ...
    .. code:: python
        ...
        from hbayesdm.models import bart_prospect_belief_lossaversion

        # Run the model and store results in "output"
        output = bart_prospect_belief_lossaversion(data='example', niter=2000, nwarmup=1000, nchain=4, ncore=4)
        ...
        print_fit(output)
    """
    return BartProspectBeliefLossaversion(
        data=data,
        niter=niter,
        nwarmup=nwarmup,
        nchain=nchain,

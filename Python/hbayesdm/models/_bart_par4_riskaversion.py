...
__all__ = ['bart_par4_riskaversion']


class BartPar4Riskaversion(TaskModel):
    def __init__(self, **kwargs):
        super().__init__(
            task_name='bart',
            model_name='par4_riskaversion',
            model_type='',
            data_columns=(
                'subjID',
                'pumps',
...
def bart_par4_riskaversion(
    ...
    """Balloon Analogue Risk Task - Re-parameterized version of BART model with only a risk aversion parameter

    Hierarchical Bayesian Modeling of the Balloon Analogue Risk Task 
    using Re-parameterized version of BART model with only a risk aversion parameter [van_Ravenzwaaij2011]_ with the following parameters:
    "gam" (risk-taking parameter).
    ...
    **additional_args
    ...
    model_data
        ...
        - ``model``: String value that is the name of the model ('bart_par4_riskaversion').
    ...
    .. code:: python
        ...
        from hbayesdm.models import bart_par4_riskaversion

        # Run the model and store results in "output"
        output = bart_par4_riskaversion(data='example', niter=2000, nwarmup=1000, nchain=4, ncore=4)

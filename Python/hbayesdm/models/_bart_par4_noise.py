...
__all__ = ['bart_par4_noise']


class BartPar4Noise(TaskModel):
    def __init__(self, **kwargs):
        super().__init__(
            task_name='bart',
            model_name='par4_noise',
            model_type='',
            data_columns=(
                'subjID',
                'pumps',
...
def bart_par4_noise(
    ...
    """Balloon Analogue Risk Task - Re-parameterized version of BART model with inverse temperature only

    Hierarchical Bayesian Modeling of the Balloon Analogue Risk Task 
    using Re-parameterized version of BART model with inverse temperature only [van_Ravenzwaaij2011]_ with the following parameters:
    "tau" (inverse temperature).
    ...
    **additional_args
    ...
    model_data
        ...
        - ``model``: String value that is the name of the model ('bart_par4_noise').
    ...
    .. code:: python
        ...
        output = bart_par4_noise(data='example', niter=2000, nwarmup=1000, nchain=4, ncore=4)

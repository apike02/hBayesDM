...
__all__ = ['bart_prospect_belief_noise']


class BartProspectBeliefNoise(TaskModel):
    def __init__(self, **kwargs):
        super().__init__(
            task_name='bart',
            model_name='prospect_belief_noise',
            model_type='',
            data_columns=(
                'subjID',
                'pumps',
...
def bart_prospect_belief_noise(
    ...
    """Balloon Analogue Risk Task - Simple model with a prior belief and decision noise

    Hierarchical Bayesian Modeling of the Balloon Analogue Risk Task 
    using Simple model with a prior belief and decision noise  with the following parameters:
    "pumps_prior_belief" (prior belief of burst), "inverse_temperature" (governs decision noise, ranging from 0 (stochastic) to infinite (deterministic)).
    ...
    **additional_args
    ...
    model_data
        ...
        - ``model``: String value that is the name of the model ('bart_prospect_belief_noise').
    ...
    .. code:: python
        ...
        from hbayesdm.models import bart_prospect_belief_noise

        # Run the model and store results in "output"
        output = bart_prospect_belief_noise(data='example', niter=2000, nwarmup=1000, nchain=4, ncore=4)
        ...
        print_fit(output)
    """
    return BartProspectBeliefNoise(
        data=data,
        niter=niter,
        nwarmup=nwarmup,
        nchain=nchain,

...
__all__ = ['bart_par4_belief_learning']


class BartPar4BeliefLearning(TaskModel):
    def __init__(self, **kwargs):
        super().__init__(
            task_name='bart',
            model_name='par4_belief_learning',
            model_type='',
            data_columns=(
                'subjID',
                'pumps',
...
def bart_par4_belief_learning(
    ...
    """Balloon Analogue Risk Task - Re-parameterized version of BART model with 2 params - belief and learning

    Hierarchical Bayesian Modeling of the Balloon Analogue Risk Task 
    using Re-parameterized version of BART model with 2 params - belief and learning [van_Ravenzwaaij2011]_ with the following parameters:
    "phi" (prior belief of balloon not bursting), "eta" (updating rate).
    ...
    **additional_args
    ...
    model_data
        ...
        - ``model``: String value that is the name of the model ('bart_par4_belief_learning').
    ...
    .. code:: python
        ...
        output = bart_par4_belief_learning(data='example', niter=2000, nwarmup=1000, nchain=4, ncore=4)

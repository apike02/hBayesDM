...
__all__ = ['bart_ewmv_minusphi']


class BartEwmvMinusphi(TaskModel):
    def __init__(self, **kwargs):
        super().__init__(
            task_name='bart',
            model_name='ewmv_minusphi',
            model_type='',
            data_columns=(
                'subjID',
                'pumps',
...
def bart_ewmv_minusphi(
    ...
    """Balloon Analogue Risk Task - Exponential-Weight Mean-Variance Model without phi

    Hierarchical Bayesian Modeling of the Balloon Analogue Risk Task 
    using Exponential-Weight Mean-Variance Model without phi [Park2020]_ with the following parameters:
    "eta" (updating exponent), "rho" (risk preference), "tau" (inverse temperature), "lambda" (loss aversion).
    ...
    **additional_args
    ...
    model_data
        ...
        - ``model``: String value that is the name of the model ('bart_ewmv_minusphi').
    ...
    .. code:: python
        ...
        output = bart_ewmv_minusphi(data='example', niter=2000, nwarmup=1000, nchain=4, ncore=4)

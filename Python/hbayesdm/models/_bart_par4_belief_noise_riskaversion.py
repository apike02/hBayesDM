...
__all__ = ['bart_par4_belief_noise_riskaversion']


class BartPar4BeliefNoiseRiskaversion(TaskModel):
    def __init__(self, **kwargs):
        super().__init__(
            task_name='bart',
            model_name='par4_belief_noise_riskaversion',
            model_type='',
            data_columns=(
                'subjID',
                'pumps',
...
def bart_par4_belief_noise_riskaversion(
    ...
    """Balloon Analogue Risk Task - Re-parameterized version of BART model with 3 params - prior belief, inverse temperature and risk aversion

    Hierarchical Bayesian Modeling of the Balloon Analogue Risk Task 
    using Re-parameterized version of BART model with 3 params - prior belief, inverse temperature and risk aversion [van_Ravenzwaaij2011]_ with the following parameters:
    "phi" (prior belief of balloon not bursting), "gam" (risk-taking parameter), "tau" (inverse temperature).
    ...
    **additional_args
    ...
    model_data
        ...
        - ``model``: String value that is the name of the model ('bart_par4_belief_noise_riskaversion').
    ...
    .. code:: python
        ...
        from hbayesdm.models import bart_par4_belief_noise_riskaversion

        # Run the model and store results in "output"
        output = bart_par4_belief_noise_riskaversion(data='example', niter=2000, nwarmup=1000, nchain=4, ncore=4)
        ...
        print_fit(output)
    """
    return BartPar4BeliefNoiseRiskaversion(
        data=data,
        niter=niter,
        nwarmup=nwarmup,
        nchain=nchain,

...
__all__ = ['bart_prospect_learning_lossaversion']


class BartProspectLearningLossaversion(TaskModel):
...
def bart_prospect_learning_lossaversion(
    ...
    """Balloon Analogue Risk Task - Simple model with fixed belief that is updated IF there is an explosion or the pumps are greater than the prior and multiplicative loss aversion

    Hierarchical Bayesian Modeling of the Balloon Analogue Risk Task 
    using Simple model with fixed belief that is updated IF there is an explosion or the pumps are greater than the prior and multiplicative loss aversion  with the following parameters:
    "learning_rate" (rate at which belief of burst is updated), "loss_aversion" (multiplied by loss value).
    ...
    **additional_args
    ...
    model_data
        ...
        - ``model``: String value that is the name of the model ('bart_prospect_learning_lossaversion').
    ...
    .. code:: python
        ...
        from hbayesdm.models import bart_prospect_learning_lossaversion

        # Run the model and store results in "output"
        output = bart_prospect_learning_lossaversion(data='example', niter=2000, nwarmup=1000, nchain=4, ncore=4)
        ...
        print_fit(output)
    """
    return BartProspectLearningLossaversion(
        data=data,
        niter=niter,
        nwarmup=nwarmup,
        nchain=nchain,

...
def gng_m5(
    ...
    """Orthogonalized Go/Nogo Task - RW (rew/pun) + noise + appbias + avbias + bias

    Hierarchical Bayesian Modeling of the Orthogonalized Go/Nogo Task 
    using RW (rew/pun) + noise + appbias + avbias + bias [Cavanagh2013]_ with the following parameters:
    "xi" (noise), "ep" (learning rate), "b" (action bias), "app" (Pavlovian approach bias), "av" (Pavlovian avoid bias), "rhoRew" (reward sensitivity), "rhoPun" (punishment sensitivity).
    ...
    **additional_args
    ...
    model_data
        ...
        - ``model``: String value that is the name of the model ('gng_m5').
    ...
    .. code:: python
        ...
        output = gng_m5(data='example', niter=2000, nwarmup=1000, nchain=4, ncore=4)

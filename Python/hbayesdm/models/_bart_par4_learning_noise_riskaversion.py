...
__all__ = ['bart_par4_learning_noise_riskaversion']


class BartPar4LearningNoiseRiskaversion(TaskModel):
    def __init__(self, **kwargs):
        super().__init__(
            task_name='bart',
            model_name='par4_learning_noise_riskaversion',
            model_type='',
            data_columns=(
                'subjID',
                'pumps',
...
def bart_par4_learning_noise_riskaversion(
    ...
    """Balloon Analogue Risk Task - Re-parameterized version of BART model with 3 params - learning, noise and riskaversion (fixed effect prior)

    Hierarchical Bayesian Modeling of the Balloon Analogue Risk Task 
    using Re-parameterized version of BART model with 3 params - learning, noise and riskaversion (fixed effect prior) [van_Ravenzwaaij2011]_ with the following parameters:
    "eta" (updating rate), "gam" (risk-taking parameter), "tau" (inverse temperature).
    ...
    **additional_args
    ...
    model_data
        ...
        - ``model``: String value that is the name of the model ('bart_par4_learning_noise_riskaversion').
    ...
    .. code:: python
        ...
        from hbayesdm.models import bart_par4_learning_noise_riskaversion

        # Run the model and store results in "output"
        output = bart_par4_learning_noise_riskaversion(data='example', niter=2000, nwarmup=1000, nchain=4, ncore=4)
        ...
        print_fit(output)
    """
    return BartPar4LearningNoiseRiskaversion(
        data=data,
        niter=niter,
        nwarmup=nwarmup,
        nchain=nchain,

...
__all__ = ['bart_prospect_learning']


class BartProspectLearning(TaskModel):
...
def bart_prospect_learning(
    ...
    """Balloon Analogue Risk Task - Simple model with a learning rate - everyone starts with same belief

    Hierarchical Bayesian Modeling of the Balloon Analogue Risk Task 
    using Simple model with a learning rate - everyone starts with same belief  with the following parameters:
    "learning_rate" (rate at which belief of burst is updated).
    ...
    **additional_args
    ...
    model_data
        ...
        - ``model``: String value that is the name of the model ('bart_prospect_learning').
    ...
    .. code:: python
        ...
        output = bart_prospect_learning(data='example', niter=2000, nwarmup=1000, nchain=4, ncore=4)

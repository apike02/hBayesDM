...
__all__ = ['bart_prospect_belief_noise_riskaversion_lossaversion']


class BartProspectBeliefNoiseRiskaversionLossaversion(TaskModel):
...
def bart_prospect_belief_noise_riskaversion_lossaversion(
    ...
    """Balloon Analogue Risk Task - Simple model with a prior belief, decision noise and risk aversion and multiplicative loss aversion

    Hierarchical Bayesian Modeling of the Balloon Analogue Risk Task 
    using Simple model with a prior belief, decision noise and risk aversion and multiplicative loss aversion  with the following parameters:
    "pumps_prior_belief" (prior belief of burst), "inverse_temperature" (governs decision noise, ranging from 0 (stochastic) to infinite (deterministic)), "risk_aversion" (subtracted from overall expected value), "loss_aversion" (multiplied by loss value).
    ...
    **additional_args
    ...
    model_data
        ...
        - ``model``: String value that is the name of the model ('bart_prospect_belief_noise_riskaversion_lossaversion').
    ...
    .. code:: python
        ...
        output = bart_prospect_belief_noise_riskaversion_lossaversion(data='example', niter=2000, nwarmup=1000, nchain=4, ncore=4)
        ...
        print_fit(output)
    """
    return BartProspectBeliefNoiseRiskaversionLossaversion(
        data=data,
        niter=niter,
        nwarmup=nwarmup,
        nchain=nchain,

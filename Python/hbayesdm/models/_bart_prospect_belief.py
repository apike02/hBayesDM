...
__all__ = ['bart_prospect_belief']


class BartProspectBelief(TaskModel):
    def __init__(self, **kwargs):
        super().__init__(
            task_name='bart',
            model_name='prospect_belief',
            model_type='',
            data_columns=(
                'subjID',
                'pumps',
...
def bart_prospect_belief(
    ...
    using Very simple model with only a single prior belief  with the following parameters:
    "pumps_prior_belief" (prior belief of burst).
    ...
    **additional_args
    ...
    model_data
        ...
        - ``model``: String value that is the name of the model ('bart_prospect_belief').
    ...
    .. code:: python
        ...
        output = bart_prospect_belief(data='example', niter=2000, nwarmup=1000, nchain=4, ncore=4)

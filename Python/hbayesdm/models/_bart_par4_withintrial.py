...
__all__ = ['bart_par4_withintrial']


class BartPar4Withintrial(TaskModel):
    def __init__(self, **kwargs):
        super().__init__(
            task_name='bart',
            model_name='par4_withintrial',
            model_type='',
            data_columns=(
                'subjID',
                'pumps',
...
def bart_par4_withintrial(
    ...
    """Balloon Analogue Risk Task - Re-parameterized version of BART model with learning updates within trial

    Hierarchical Bayesian Modeling of the Balloon Analogue Risk Task 
    using Re-parameterized version of BART model with learning updates within trial [van_Ravenzwaaij2011]_ with the following parameters:
    ...
    **additional_args
    ...
    model_data
        ...
        - ``model``: String value that is the name of the model ('bart_par4_withintrial').
    ...
    .. code:: python
        ...
        output = bart_par4_withintrial(data='example', niter=2000, nwarmup=1000, nchain=4, ncore=4)

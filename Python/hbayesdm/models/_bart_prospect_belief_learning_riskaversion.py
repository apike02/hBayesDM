...
__all__ = ['bart_prospect_belief_learning_riskaversion']


class BartProspectBeliefLearningRiskaversion(TaskModel):
    def __init__(self, **kwargs):
        super().__init__(
            task_name='bart',
            model_name='prospect_belief_learning_riskaversion',
            model_type='',
            data_columns=(
                'subjID',
                'pumps',
...
def bart_prospect_belief_learning_riskaversion(
    ...
    """Balloon Analogue Risk Task - Simple model with a prior belief that is updated IF there is an explosion or the pumps are greater than the prior and summative risk aversion

    Hierarchical Bayesian Modeling of the Balloon Analogue Risk Task 
    using Simple model with a prior belief that is updated IF there is an explosion or the pumps are greater than the prior and summative risk aversion  with the following parameters:
    "pumps_prior_belief" (prior belief of burst), "learning_rate" (rate at which belief of burst is updated), "risk_aversion" (additive value that makes you less likely to pump).
    ...
    **additional_args
    ...
    model_data
        ...
        - ``model``: String value that is the name of the model ('bart_prospect_belief_learning_riskaversion').
    ...
    .. code:: python
        ...
        from hbayesdm.models import bart_prospect_belief_learning_riskaversion

        # Run the model and store results in "output"
        output = bart_prospect_belief_learning_riskaversion(data='example', niter=2000, nwarmup=1000, nchain=4, ncore=4)
        ...
        print_fit(output)
    """
    return BartProspectBeliefLearningRiskaversion(
        data=data,
        niter=niter,
        nwarmup=nwarmup,
        nchain=nchain,

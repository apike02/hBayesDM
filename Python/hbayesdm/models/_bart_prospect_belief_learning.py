...
__all__ = ['bart_prospect_belief_learning']


class BartProspectBeliefLearning(TaskModel):
...
def bart_prospect_belief_learning(
    ...
    """Balloon Analogue Risk Task - Simple model with a prior belief that is updated IF there is an explosion or the pumps are greater than the prior

    Hierarchical Bayesian Modeling of the Balloon Analogue Risk Task 
    using Simple model with a prior belief that is updated IF there is an explosion or the pumps are greater than the prior  with the following parameters:
    "pumps_prior_belief" (prior belief of burst), "learning_rate" (rate at which belief of burst is updated).
    ...
    **additional_args
    ...
    model_data
        ...
        - ``model``: String value that is the name of the model ('bart_prospect_belief_learning').
    ...
    .. code:: python
        ...
        output = bart_prospect_belief_learning(data='example', niter=2000, nwarmup=1000, nchain=4, ncore=4)
        ...
        print_fit(output)
    """
    return BartProspectBeliefLearning(
        data=data,
        niter=niter,
        nwarmup=nwarmup,
        nchain=nchain,

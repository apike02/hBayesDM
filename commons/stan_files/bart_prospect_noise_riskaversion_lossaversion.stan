/* BART model: 'Noise + risk aversion + Loss aversion'
*  author: Alex Pike
...
transformed parameters {
  ...
  for (i in 1:N){
      inverse_temperature[i]=(mu_pr[1] + sigma[1] * inverse_temperature_pr[i])^2;
...
generated quantities {
  ...
  real<lower=0> mu_inverse_temperature = (mu_pr[1])^2;

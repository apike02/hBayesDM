/* BART model: 'Learning rate + belief + risk aversion + Loss aversion'
*  author: Alex Pike
...
transformed parameters {
  ...
  for (i in 1:N){
      pumps_prior_belief[i]=Phi_approx(mu_pr[1] + sigma[1]* pumps_prior_belief_pr[i]);
...
generated quantities {
  ...
  real mu_risk_aversion = exp(mu_pr[3]);
  real mu_loss_aversion = exp(mu_pr[4]);
